...
$form->add_select('Select Group','ticketing_group_id','ticketing_groups','id','name','name','');
...
$fields = array('name','price','status','event_id','artist_id','venue_id','auditorium_id','ticketing_group_id');
