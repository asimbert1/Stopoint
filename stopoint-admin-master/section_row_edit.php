...
$form->add_select('Section','section_id','auditorium_sections','id','name','name','','id'. $idd);
$form->add_text('Name: ', 'name');	
$form->add_text('Number of Seats: ', 'no_of_seats');	
...
$fields = array('section_id','name','no_of_seats');
...
<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<a href="<?=$_SERVER['PHP_SELF']?>"><h2>Rows</h2></a>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3><?php echo getTitle($action); ?> Rows</h3>
