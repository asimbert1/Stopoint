...
$table_name = 'general_entry_tickets';
...
$table->addJoined('Ticket Group', 'ticketing_group_id', true, 'ticketing_groups', 'name', 'id');
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                        ...
                        <a href="ticket_groups.php" class="link_button" style="font-size: 20px;">Manage Ticket Groups</a>
						<br>
						<br>
						...
						<table>
							...
							<tbody>
								...
								$formx = new table_form('general_entry_tickets', "form");
