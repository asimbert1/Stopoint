...
$table->addField('Seat Name', 'name', true, '', ''); 
...
?>
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<a href="<?=$_SERVER['PHP_SELF']?>?id=<?php echo $_GET['a_id'];?>"><h2>Row Seats</h2></a>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header2">
					...
					<h3><?=$_SESSION['venue_link']?> >> <?=$_SESSION['auditorium_link']?> >> <?=$_SESSION['section_link']?> >> Row Name:<a href="section_row.php?a_id=<?=$_SESSION['section_link_aid']?>">
                    <?php 
					
					$formx2 = new table_form('section_row', "form");
				...
				<div class="content-box-content">
						...
						<table>
							...
							<tbody>
								...
								$formx = new table_form('row_seats', "form");
									$rowx = $formx->get_row("id",$row['id']);
						//	print_r($rowx['venue_id']);exit;
								if ($rowx['row_id']==$_GET['a_id']){
