...
$form->add_text('copon_code : ', 'copon_code');
//$form->add_text('Photo : ', 'UserId');
$form->add_text('Description : ', 'Description');
$form->add_text('Expiration_date : ', 'Expiration_date');
...
$fields = array('copon_code','Description','Expiration_date');
