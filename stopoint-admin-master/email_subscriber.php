...
$table->addField('Email Address', 'EmailAddress', true, '', '');
$table->addField('', 'IsNewsletter', false, '', '');
// which fields to be searchable
$table->searchable = array('id','EmailAddress'); 

// checks for delete/add and displays notifications
if (isset($_GET['delete'])) {
	
	
		$db->query("UPDATE user SET `IsNewsletter` = 0 WHERE `id` = ".$_GET['delete']); 
		$action_msg = show_notification("The entry you selected was unsubscribe succesfully","success",true);
...
$(document).ready(function(){ 
	...
	$(function() {
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<a href="<?=$_SERVER['PHP_SELF']?>?sort=EmailAddress"><h2>Users</h2></a>
...
?>							
								<tr id="events_<?=$row['id']?>">
									...
									<td>
										 ...
										 <!--<a href="<?php //echo edit_url($table->current_id); ?>" title="Edit"><img src="<?=$base_url; ?>/images/icons/pencil.png" alt="Edit" /></a>-->
