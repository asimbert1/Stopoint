...
$_GET['sort'] = 'id';
$_GET['sort'] = 'Date';
$table_name = 'contactusrequest';
$table = new table($table_name);
$table->addField('Id', 'id', false, '', '');     
$table->addField('Name', 'name', false, '', ''); 
//$table->addField('Last Name', 'LastName', false, '', ''); 
//$table->addJoined('email', 'email', true, 'training_types', 'type_title', 'id'); 
$table->addField('Email', 'email', false, '', '');
$table->addField('Subject', 'subject', false, '', '');
$table->addField('Date', 'Date', true, '', '');
//$table->addField('Comments', 'comments', false, '', '');
//$table->addField('Phone', 'phone', false, '', ''); 
//$table->addField('City', 'city', false, '', ''); 
//$table->addField('Birth Date', 'birth_date', false, '', ''); 
//$table->addField('Role', 'role', false, '', ''); 
//$table->addField('Active', 'isactive', false, '', ''); 
// which fields to be searchable
$table->searchable = array('id','name','email','subject','date'); 
...
$(document).ready(function(){ 
	...
	$(function() {
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<a href="<?=$_SERVER['PHP_SELF']?>?sort=Date&desc"><h2>Contact Us</h2></a>
									...
									<?php  foreach ($row as $key => $value) { ?>
										  ...
										  <td>
												<?php 
													if($key == 'Date')
													{
														echo date('m/d/Y h:i:s', strtotime(html_entity_decode(stripslashes($value))));
