...
$form->add_dropdown('User Type','UserType',array(array('name'=>'User','value'=>'User')));


//$form->add_text('Date of Birth : ', 'dob');

$form->add_text('Shipping Address 1 : ', 'S_AddressLine1');

$form->add_text('Shipping Address 2 : ', 'S_AddressLine2');
...
$form->add_text('Billing Address 1 : ', 'B_AddressLine1');

$form->add_text('Billing Address 2 : ', 'B_AddressLine2');

$form->add_text('City : ', 'B_City');

$form->add_text('State : ', 'B_State');

$form->add_text('Postal Code : ', 'B_PostalCode');

$form->add_text('Country : ', 'B_Country');
...
$fields = array('FirstName','LastName','EmailAddress','Password','UserType','S_AddressLine1','S_AddressLine2','S_City','S_State','S_PostalCode','S_Country','B_AddressLine1','B_AddressLine2','B_City','B_State','B_PostalCode','B_Country','Phone');
...
<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<a href="<?=$_SERVER['PHP_SELF']?>"><h2>Customers</h2></a>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3><?php echo getTitle($action); ?> Customers</h3>
