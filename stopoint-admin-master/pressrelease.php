...
$table->addJoined('Source', 'source', false, '', '');
$table->addField('Title', 'title', false, '', '');
$table->addField('Date Posted', 'dateposted', false, '', '');
$table->searchable = array('id','source','title'); 
...
$(document).ready(function(){ 
	...
	$(function() {
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<a href="<?=$_SERVER['PHP_SELF']?>?sort=Date&desc"><h2>Press Release</h2></a>
