...
<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
								...
								<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
									...
									<?php while ($field = $form->get_field()) {	?>
										<p>
											...
											if($field[name]== 'Name : '){
											?>
                                            <span style="font-size:14px"><?=$weuser['FirstName'].' '.$weuser['LastName'].' (Admin)'?></span>
                                            <?php
											}elseif($field[name]== 'Subject : '){
												if($field[value]==''){
											?>
                                            <span style="font-size:14px"><?php echo "No Subject";?></span>
                                            <?php
											}else{
											?>
                            ...
                            <button class="button" style="display:none;">Reply</button>
