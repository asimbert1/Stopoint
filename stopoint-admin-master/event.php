...
$table->addField('Description', 'description', true, '', ''); 
$table->addField('Event Type', 'type', true, '', ''); 
$table->addField('Date', 'date', true, '', ''); 
// which fields to be searchable
$table->searchable = array('id','name','description'); 
								...
								<tr id="events_<?=$row['id']?>">
									...
									<?php  foreach ($row as $key => $value) { ?>
										  ...
										  <td>
												<?php
												if($key=='image_url'){ 
												echo '<a href="'.$base_url.'/event_images/'.$value.'" >';
												echo '<img src="'.$base_url.'/event_images/'.$value.'" width="70">';
												echo '</a>';
									...
									<td>
										...
										<?php if($row['type']=='General Entry'){
											?>
                                            <a href="general_entry_ticket.php?a_id=<?php echo $table->current_id; ?>" title="Tickets"><img src="<?=$base_url; ?>/images/icons/ticket.png" alt="Tickets" /></a>
                                            <?php
											}else{?>
										<a href="ticket.php?a_id=<?php echo $table->current_id; ?>" title="Tickets"><img src="<?=$base_url; ?>/images/icons/ticket.png" alt="Tickets" /></a>
                                        <?php } ?>
