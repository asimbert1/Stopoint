...
/*$pdf->StartTransform();
$pdf->Translate(5, 160);
$file="returnlabels/newlabel_$orderid.png";
$pdf->setImageScale(1.53);
$pdf->SetXY(25, 20);
*/
$file="returnlabels/label_$orderid.png";
$pdf->setImageScale(1.53);
//$pdf->Image($file, '', '', '', '', '', '', 'T', false, 600, '', false, false, 1, false, false, false);
...
$pdf->StartTransform();
$pdf->Translate(15, 155);
$pdf->Rotate(90, 0, 25);
$pdf->write1DBarcode($trackingid, 'C128', '', '',  70, 25, 0.4, $style, 'N');
$pdf->StopTransform();
// ---------------------------------------------------------
