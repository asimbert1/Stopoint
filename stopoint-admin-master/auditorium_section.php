...
$table->addField('Section Name', 'name', true, '', '');
$table->addField('Section rows', 'no_of_rows', true, '', ''); 
...
if (isset($_GET['delete'])) {
	...
	$spaceId = $_GET['a_id']; 
		$spacedel = $venuesClient->removeSection($sectionId ,$spaceId);
...
?>
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<a href="<?=$_SERVER['PHP_SELF']?>?id=<?php echo $_GET['a_id'];?>"><h2>Auditorium Sections</h2></a>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3><?=$_SESSION['venue_link']?> >> Auditorium Name:<a href="auditorium.php?a_id=<?=$_SESSION['venue_link_aid']?>">
                    <?php 
					
					$formx2 = new table_form('auditorium', "form");
									$rowx2 = $formx2->get_row("id",$_GET['a_id']);
									$_SESSION['auditorium_link']="Auditorium Name: <a href='auditorium.php?a_id=".$_SESSION['venue_link_aid']."'>".$rowx2['name']."</a>";
									$_SESSION['auditorium_link_aid']=$_GET['a_id'];
									echo $rowx2['name'];
					?>
                    </a>
                    </h3>
				...
				<div class="content-box-content">
						...
						<table>
							...
							<tbody>
								...
								$formx = new table_form('auditorium_sections', "form");
									$rowx = $formx->get_row("id",$row['id']);
						//	print_r($rowx['venue_id']);exit;
								if ($rowx['auditorium_id']==$_GET['a_id']){
								...
								<tr>
									...
									<td>
										&nbsp;
										<a href="section_row.php?a_id=<?php echo $table->current_id; ?>" title="Section Rows"><img src="<?=$base_url; ?>/images/icons/row.png" alt="Section Rows" /></a>
