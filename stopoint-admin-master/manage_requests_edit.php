			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                            ...
                            <form name="form1" id="reply" method="post" action="" style="border: 1px solid #ccc; padding:15px; margin-top:10px;">
                               ...
                               <input readonly="readonly" class="text-input" style="width:25%" name="form_name" id="form_name" type="text" value="<?=$row['Name']?>" >
                            
                              <label style="display: block; padding: 10px 0px 10px; font-weight: bold; font-size: 14px;" for="form_email">Email :</label>
                              <input readonly="readonly" class="text-input" style="width:25%" name="form_email" id="form_email" type="email" value="<?=$row['Email']?>" >
                              <label style="display: block; padding: 10px 0px 10px; font-weight: bold; font-size: 14px;" for="form_subject">Subject :</label>
                              <input class="text-input" style="width:37%" name="form_subject" id="form_subject" type="text" value="Reply:<?=$row['Subject']?>" >
