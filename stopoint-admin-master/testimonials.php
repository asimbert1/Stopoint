...
$table->addJoined('User Name', 'UserName', false, '', '');
$table->addField('Date', 'Date', true, '', '');
$table->addField('Show On Home Page', 'ShowOnHomePage', false, '', '');
$table->addField('Rating', 'Rate', false, '', '');
$table->searchable = array('id','name','message','date'); 
...
$(document).ready(function(){ 
	...
	$(function() {
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<a href="<?=$_SERVER['PHP_SELF']?>?sort=Date&desc"><h2>Testimonials</h2></a>
									...
									<?php  foreach ($row as $key => $value) { ?>
										  ...
										  <td>
												<?php 
													if($key=='Rate'){
												?>
													<div class="rb-rating" data-average="<?=$value?>" data-id="5"></div>
                                                 <?php
													}
