...
$table->addJoined('Product Category', 'CategoryId', false, 'productcategory', 'Name', 'id'); 
$table->addJoined('Product Family', 'FamilyId', false, 'productfamily', 'Name', 'id');

/*$table->addField('Description', 'Description', true, '', '');*/
$table->addField('Good Price', 'GoodPrice', true, '', '');
$table->addField('Flawess Price', 'FlawessPrice', true, '', '');
...
$table->searchable = array('id','ProductModel','place'); 
...
$(document).ready(function(){ 
	...
	$(function() {
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<a href="<?=$_SERVER['PHP_SELF']?>"><h2>Products</h2></a>
