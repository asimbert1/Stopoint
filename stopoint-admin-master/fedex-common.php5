...
function writeToLog($client){  
	 ...
	 */
	if (!$logfile = fopen('/home/stopoint/public_html/Stopoint/fedextransactions.log', "w"))
	{
...
function getProperty($var){
	...
	if($var == 'billaccount') Return '633631263'; 
	if($var == 'dutyaccount') Return '633631263'; 
	if($var == 'freightaccount') Return '633631263';  
	if($var == 'trackaccount') Return '633631263'; 
	if($var == 'dutiesaccount') Return '633631263';
	if($var == 'importeraccount') Return '633631263';
	if($var == 'brokeraccount') Return '633631263';
	if($var == 'distributionaccount') Return '633631263';
	if($var == 'locationid') Return 'PLBA';
	if($var == 'printlabels') Return true;
	if($var == 'printdocuments') Return true;
	if($var == 'packagecount') Return '1';

	if($var == 'meter') Return '107820028';
	...
	if($var == 'shippingchargespayment') Return array(
		...
		'Payor' => array(
			'ResponsibleParty' => array(
				...
				'Contact' => 'FedEx Freight LTL Bill To/Third Party',
				'Address' => array(
		'StreetLines'=> array('2000 Freight LTL Testing','Do Not Delete - Test Account'),
		'City'=>' Harrison',
