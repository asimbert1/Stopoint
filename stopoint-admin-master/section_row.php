...
$table_name = 'section_row';
$table = new table($table_name);
$table->addField('Id', 'id', false, '', '');     
//$table->addField('Name', 'name', true, '', ''); 
//$table->addField('Place', 'place', true, '', ''); 
//$table->addJoined('Section', 'section_id', true, 'auditorium_sections', 'name', 'id'); 
$table->addField('Row Name', 'name', true, '', ''); 
$table->addField('Row Seats', 'no_of_seats', true, '', ''); 
//$table->addField('Map', 'image_url', true, '', ''); 
// which fields to be searchable
$table->searchable = array('id','name','no_of_seats'); 
...
?>
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<a href="<?=$_SERVER['PHP_SELF']?>?id=<?php echo $_GET['a_id'];?>"><h2>Section Rows</h2></a>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3><?=$_SESSION['venue_link']?> >> <?=$_SESSION['auditorium_link']?> >> Section Name:<a href="auditorium_section.php?a_id=<?=$_SESSION['auditorium_link_aid']?>">
                    <?php 
					
					$formx2 = new table_form('auditorium_sections', "form");
									$rowx2 = $formx2->get_row("id",$_GET['a_id']);
									$_SESSION['section_link']="Section Name: <a href='auditorium_section.php?a_id=".$_SESSION['auditorium_link_aid']."'>".$rowx2['name']."</a>";
									$_SESSION['section_link_aid']=$_GET['a_id'];
									//print_r($rowx2);
									echo $rowx2['name'];
					?>
                    </a>
				...
				<div class="content-box-content">
						...
						<table>
							...
							<tbody>
								...
								$formx = new table_form('section_row', "form");
									$rowx = $formx->get_row("id",$row['id']);
						//	print_r($rowx['venue_id']);exit;
								if ($rowx['section_id']==$_GET['a_id']){
								...
								<tr>
									...
									<td>
										&nbsp;
										<a href="row_seat.php?a_id=<?php echo $table->current_id; ?>" title="Seats"><img src="<?=$base_url; ?>/images/icons/seat.png" alt="Seats" /></a>
