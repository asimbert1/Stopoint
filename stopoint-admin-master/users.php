...
$table->searchable = array('id','FirstName','LastName'); 
				...
				<div class="content-box-content">
						...
						<table>
							...
							<tbody>
								...
								<?php while ($row = $table->fetch("`user`.`UserType` = 'Sub Admin' OR `user`.`UserType` = 'Super Admin'")) { 
...
if($row['UserType'] == 'Sub Admin' || $row['UserType'] == 'Super Admin'){
