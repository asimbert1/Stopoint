...
$form->add_readonly('User Name : ', 'UserName');
$form->add_readonly('Product : ', 'OrderId');
$form->add_text('Title : ', 'Name');
$form->add_textarea('Message : ', 'Contents', $row['Contents']);
$form->add_dropdown('Show On Home Page : ','ShowOnHomePage',array(array('name'=>'Yes','value'=>'1'),array('name'=>'No','value'=>'0')));
$form->add_text('Rating : ', 'Rate');
...
$fields = array('Name','Contents','ShowOnHomePage','Rate');
