...
$table->addField('Page Title', 'PageTitle', false, '', '');
$table->addField('Page Contents', 'PageContents', false, '', '');
...
$table->searchable = array('id','PageTitle'); 
...
$(document).ready(function(){ 
	...
	$(function() {
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<a href="<?=$_SERVER['PHP_SELF']?>"><h2>Site Pages</h2></a>
							...
							<tbody>
								...
								<tr id="events_<?=$row['id']?>">
									...
									<?php  foreach ($row as $key => $value) { ?>
										  ...
										  <td>
												<?php 
													if($key=='PageContents' && strlen($row['PageContents']) >= 150)
													{
														echo substr(html_entity_decode(stripslashes($value)),0,150).'...';
													}
													else
