...
<?php
 ...
 ?>
      <li class="<?php if($_GET['id'] == ''  && $_GET['model'] =='' && $_GET['family'] ==''){ echo 'active' ;} else { echo '' ;} ?>"><a href="#tab1" data-toggle="tab"><div class="step-no">1</div>SELECT BRAND</a></li>
     ...
     <li class="<?php if($_GET['family'] != ''){ echo 'active' ;} else { echo '' ;} ?>"><a href="#tab3" <?php if(isset($_SESSION['family'])){?> data-toggle="tab" <?php } ?>><div class="step-no">3</div>SELECT MODEL</a></li>
             
      <li class="<?php if($_GET['model'] != ''){ echo 'active' ;} else { echo '' ;} ?>"><a href="#tab4" <?php if(isset($_SESSION['model'])){?> data-toggle="tab" <?php } ?>><div class="step-no">4</div>SELECT CONDITION</a></li>
    </ul>
</div><!-- end container --> 
...
<!-- row --> 
<div class="tab-pane fade tab_bg <?php if($_GET['id'] == '' && $_GET['model'] =='' && $_GET['family'] ==''){ echo 'active in' ;} else { echo 'inactive' ;} ?>" id="tab1">
...
<div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 maincenter">
    ...
    <div class="tab-content">
      ...
      <?php
	  $querybrand =  "SELECT DISTINCT productbrand.Name as `brandname`,productbrand.id as `brandid` from product INNER JOIN `productbrand` ON productbrand.id=product.BrandId WHERE product.CategoryId = 24 ";
	$resultbrands = mysql_query($querybrand);
	while($resultbrand = mysql_fetch_array($resultbrands)){
	
	 $querybrandimg =  "SELECT productfamily.image_url as `image_url` from productfamily WHERE productfamily.CategoryId = 24 AND productfamily.BrandId =".$resultbrand['brandid'];
	$resultbrandsimg = mysql_query($querybrandimg);
	$resultbrandimg = mysql_fetch_assoc($resultbrandsimg);
	
	  ?>
        <a href="<?php echo $base_url; ?>/sell/gadgets/<?php echo str_replace(" ","-",$resultbrand['brandname']); ?>"><div class="portfolio-block col-lg-3 col-md-3 col-sm-4"> 
        <?php
		if($resultbrandimg['image_url'] != ""){ ?>
		<img class="fix img-responsive" alt="TV" style="height:179px;" src="<?php echo $base_url ?>/productimages/<?php echo $resultbrandimg['image_url']; ?>"/>	
			<?php }
			else{
		?>
        <img class="fix img-responsive" alt="TV" src="<?php echo $base_url ?>/images/TV.png"/>
        <?php
			}
		?>
	...
	$resultbrandimg = mysql_fetch_assoc($resultbrandsimg);
	  ...
	  ?>
        <li><a href="<?php echo $base_url; ?>/sell/gadgets/<?php echo str_replace(" ","-",$resultbrand['brandname']); ?>">
        <?php
		if($resultbrandimg['image_url'] != ""){ ?>
...
<div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1">
<h1 class="newheading1" style="font-size:24px; margin:0px;">Sell your <?php echo $_GET['id']; ?> for cash</h1>
<h2 class="newheading2" style="font-size:16px; margin:10px 0px 20px 0px;">It takes just a few minutes to sell your <?php echo $_GET['id']; ?>.</h2>
</div>
<div class="row pad ">
</div>
...
<div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 maincenter">
	...
	while($resultfamilyy = mysql_fetch_array($resultfamiliess)){
		?>
        <a href="<?php echo $base_url; ?>/sell/gadgets/<?php echo str_replace(" ","-",$resultfamilyy['brandname']); ?>/<?php echo str_replace(" ","-",$resultfamilyy['familyname']); ?>"><div class="portfolio-block col-lg-3 col-md-3 col-sm-4">
         <?php 
		if($resultfamilyy['familyimage'] != ""){
			?>
            <img class="fix img-responsive" style="height:179px;" alt="TV" src="<?php echo $base_url ?>/productimages/<?php echo $resultfamilyy['familyimage']; ?>"/>
            <?php
			}
		else{ 
		?> 
	...
	while($resultfamilyy = mysql_fetch_array($resultfamiliess)){
		?>
        <li><a href="<?php echo $base_url; ?>/sell/gadgets/<?php echo str_replace(" ","-",$resultfamilyy['brandname']); ?>/<?php echo str_replace(" ","-",$resultfamilyy['familyname']); ?>">
         <?php 
		if($resultfamilyy['familyimage'] != ""){
			?>
...
$querymemory1 =  "SELECT product.id as productid  , product.Description as `productdescription`, product.image_url as `image_url` , product.ProductModel as 'productmodel', productfamily.Name as `familyname` , product.StorageCapacity as 'storagecapacity',productbrand.Name as `brandname` from product   INNER JOIN `productfamily` ON productfamily.id=product.FamilyId INNER JOIN `productbrand` ON productbrand.id=product.BrandId WHERE productfamily.Name ='".$_SESSION['family']."' AND product.CategoryId = 24 AND productbrand.Name ='".$_SESSION['id']."'";
$resultmemories1 = mysql_query($querymemory1);
	while($resultmemory1 = mysql_fetch_array($resultmemories1)){
?>
     <div class="nomobile">
     <a href="<?php echo $base_url; ?>/sell/gadgets/<?php echo str_replace(" ","-",$resultmemory1['brandname']); ?>/<?php echo str_replace(" ","-",$resultmemory1['familyname']); ?>/<?php echo $resultmemory1['productid']?>"><div class="col-lg-3 col-md-3 col-sm-3 portfolio-block">
     
       <?php
	 if($resultmemory1['image_url'] != ""){
		 ?>
     <img class="fix img-responsive" style="height:179px;" alt="gen" src="<?php echo $base_url ?>/productimages/<?php echo $resultmemory1['image_url']; ?>"/>      
         <?php
	 }
	 else{
	 ?>
     ...
     <li><a href="<?php echo $base_url; ?>/sell/gadgets/<?php echo str_replace(" ","-",$resultmemory1['brandname']); ?>/<?php echo str_replace(" ","-",$resultmemory1['familyname']); ?>/<?php echo $resultmemory1['productid']?>">
     
       <?php
	 if($resultmemory1['image_url'] != ""){
		 ?>
         <div class="prod_img">
     <img class="cellimg" alt="gen" src="<?php echo $base_url ?>/productimages/<?php echo $resultmemory1['image_url']; ?>"/></div>
         <?php
	 }
	 else{
	 ?>
     <div class="prod_img">
     <img class="cellimg" alt="TV" src="<?php echo $base_url ?>/images/TV.png"/>
     </div>
	 <?php } ?>
...
<!--Step 3 ENDS-->
<!--Step 4 Starts-->
<div class="tab-pane fade tab_bg <?php if($_GET['model'] != '' ){ echo 'active in' ;} else { echo 'inactive' ;} ?>" id="tab4">
...
?>
   <!-- <h3 class="Sheading-styleh3">Your Selected model is <span style="color:#000;"><?php //echo $family ;?></span> <span style="color:#000;"> <?php //echo $resultproduct['storagecapacity']; ?> (WiFi) </span></h3>
</div>--><!-- row --> 
 <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1">
...
<div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1">
	 ...
	 if($resultproduct['image_url'] != ""){
		 ?>
     <img class="fix img-responsive" style="height:179px;" alt="TV image" src="<?php echo $base_url ?>/productimages/<?php echo $resultproduct['image_url']; ?>"; />      
         <?php
	 }
	 else{
	 ?>
     <img class="fix" alt="apple tv" src="<?php echo $base_url ?>/images/TV.png"; ?>"/>"/>
       <?php } ?>
	 ...
	 if($resultproduct['image_url'] != ""){
         ...
         <li>
         <a href="">
     <img class="cellimg" alt="TV image" src="<?php echo $base_url ?>/productimages/<?php echo $resultproduct['image_url']; ?>"; />      
         <?php
	 }
	 else{
	 ?>
     <div class="prod_img">
     <img class="cellimg" alt="apple tv" src="<?php echo $base_url ?>/images/TV.png" /></div>
       <?php } ?>
