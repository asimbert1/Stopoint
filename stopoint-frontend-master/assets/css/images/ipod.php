        ...
        <div class="col-xs-12 col-sm-6 no-margin">
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="index.php">Home</a></li>
                        <li><a href="index-2.php">Home Alt</a></li>
                        <li><a href="category-grid.php">Category - Grid/List</a></li>
                        <li><a href="category-grid-2.php">Category 2 - Grid/List</a></li>
                        <li><a href="single-product.php">Single Product</a></li>
                        <li><a href="single-product-sidebar.php">Single Product with Sidebar</a></li>
                        ...
                        <li><a href="authentication.php">Login/Register</a></li>
                    </ul>
                </li>
            </ul>
        </div><!-- /.col -->
        ...
        <div class="control-group">
            ...
            <ul class="categories-filter animate-dropdown">
                <li class="dropdown">
                    ...
                    <a class="dropdown-toggle"  data-toggle="dropdown" href="category-grid.php">all categories</a>

                    <ul class="dropdown-menu" role="menu" >
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.php">laptops</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.php">tv & audio</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.php">gadgets</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.php">cameras</a></li>
...
<div class="link-widget">
    <div class="widget">
        ...
        <ul>
            ...
            <li><a href="category-grid.php">Cameras &amp; Photography</a></li>
            <li><a href="category-grid.php">Smart Phones &amp; Tablets</a></li>
            <li><a href="category-grid.php">Video Games &amp; Consoles</a></li>
            <li><a href="category-grid.php">TV &amp; Audio</a></li>
            <li><a href="category-grid.php">Gadgets</a></li>
            <li><a href="category-grid.php">Car Electronic &amp; GPS</a></li>
            <li><a href="category-grid.php">Accesories</a></li>
        </ul>
    </div><!-- /.widget -->
</div><!-- /.link-widget -->
...
<div class="link-widget">
    <div class="widget">
        ...
        <ul>
            ...
            <li><a href="category-grid.php">About Us</a></li>
            <li><a href="category-grid.php">Contact Us</a></li>
            <li><a href="category-grid.php">Weekly Deals</a></li>
            <li><a href="category-grid.php">Gift Cards</a></li>
            <li><a href="category-grid.php">Recycling Program</a></li>
            <li><a href="category-grid.php">Community</a></li>
            <li><a href="category-grid.php">Careers</a></li>
...
<div class="link-widget">
    <div class="widget">
        ...
        <ul>
            ...
            <li><a href="category-grid.php">Order Tracking</a></li>
            <li><a href="category-grid.php">Wish List</a></li>
            <li><a href="category-grid.php">Customer Service</a></li>
            <li><a href="category-grid.php">Returns / Exchange</a></li>
            <li><a href="category-grid.php">FAQs</a></li>
            <li><a href="category-grid.php">Product Support</a></li>
            <li><a href="category-grid.php">Extended Service Plans</a></li>
        </ul>
    </div><!-- /.widget -->
</div><!-- /.link-widget -->
...
<!--    <div class="config open">
        <div class="config-options">
            ...
            <ul class="list-unstyled">
                ...
                <li><a href="index-2.php">Header 2</a></li>
            </ul>
            <h4>Colors</h4>
            <ul class="list-unstyled">
