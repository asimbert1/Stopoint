...
<style type="text/css">
h3{ margin:0.67em 0; display:block; -webkit-margin-before:0.67em; -webkit-margin-after:0.67em; -webkit-margin-start:0px; -webkit-margin-end:0px;}
...
.slider h3 span{ font-size: 60px; color:#333; }
.steps h3 {
    padding-top: 70px;
...
<div class="col-lg-6 col-md-6 col-lg-offset-6">
  ...
  <h3 style="font-size:35px; margin-top:0px; margin-bottom:7px" class="customH2">TRADE-IN YOUR CELL PHONE <span>& </span> ELECTRONICS</h3>

  <h4 style="font-size:31px; margin-bottom:20px;">Your Offer is Just Seconds Away</h4>
...
<div class="hiw container">
  ...
  <div class="row text-center" style="margin-bottom:25px;">
    ...
    <h3 class="Mheding-style1 ">How It Works</h3>

    <div class="underline1"></div>

    <h4 class="Sheading-style1 ">3 EASY STEPS</h4>
...
<div class="container-fluid hotitems">
  ...
  <div class="row text-center">
    ...
    <h3 class="Mheding-style1 color">Sell Your Gadgets</h3>
...
<h3 class="Mheding-style1">REVIEWS</h3>
...
?>
	  ...
	  <div class="tm text-center col-lg-4 col-md-4 col-sm-4">
		...
		<h4><?=$testimonial[0][7]?>, <span><?=$testimonial[0][5]?></span></h4>
      ...
      <div class="tm text-center col-lg-4 col-md-4 col-sm-4">
        ...
        <h4><?=$testimonial[1][7]?>, <span><?=$testimonial[1][5]?></span></h4>
      ...
      <div class="tm text-center col-lg-4 col-md-4 col-sm-4">
        ...
        <h4><?=$testimonial[2][7]?>, <span><?=$testimonial[2][5]?></span></h4>
...
<div class="container-fluid mobiletestimonials" style="padding:0px;">
  ...
  <div class="container">
    ...
    <div class="row text-center" style="margin-bottom:20px;">
      ...
      <h3 class="Mheding-style1">TESTIMONIALS</h3>
...
<h3>MATCH5</h3>
<h4>MATCH5 Promise: The Best Price … Plus $5 More</h4>
...
<div class="your_offers">
	<h4>Your Offer is Just Seconds Away</h4>
<ul>
	<li><img src="<?php echo $base_url; ?>/images/topbar/icon9.png" alt="FREE-SHIPPING Icon"/>FREE SHIPPING</li>
    <li><img src="<?php echo $base_url; ?>/images/topbar/icon11.png" alt="NO-RISK Icon"/>NO RISK</li>
...
<div class="container-fluid mobiletestimonials testimonials" style="padding:0px;margin: -15px;">
  ...
  <div class="container">
    ...
    <div class="row text-center" style="margin-bottom:20px;">
      ...
      <h3 class="Mheding-style1" style="margin-bottom: -20px;">REVIEWS</h3>
...
<div style="width:100%; height: 2px; background:#ccc;">
    ...
    <div class="row" style="margin-left:0px; margin-right:0px;">
      	...
      	<div class="tm text-center col-lg-12 col-md-12 col-sm-12" style="margin-bottom:10px;">
            ...
            <h4 style="margin-top: 8px;"><?=$testimonial[0][7]?>, <span><?=$testimonial[0][5]?></span></h4>
