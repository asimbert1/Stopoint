...
function getProperty($var){
	if($var == 'key') Return 'NdBNYQSr8jm5ml0n'; 
	if($var == 'password') Return 'nbINQbgHepnnIQXINMGlfKZII'; 
	if($var == 'shipaccount') Return '100';
	if($var == 'billaccount') Return '200'; 
	if($var == 'dutyaccount') Return 'XXX'; 
	if($var == 'freightaccount') Return 'XXX';  
	if($var == 'trackaccount') Return '20'; 
	if($var == 'dutiesaccount') Return 'XXX';
	if($var == 'importeraccount') Return 'XXX';
	if($var == 'brokeraccount') Return '50';
	...
	if($var == 'trackingnumber') Return 'STP10101010101';
