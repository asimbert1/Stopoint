...
$pdf->SetAuthor('Syed Noman Ahmed | Website :www.nomanahmed.com | email:noman.ahmed@live.com | skype:snoman.ahmed');
...
$params = $pdf->serializeTCPDFtagParameters(array($bcode, 'C128', '', '', 70, 25, 0.4, array('position'=>'S', 'border'=>false, 'padding'=>4, 'fgcolor'=>array(0,0,0), 'bgcolor'=>array(255,255,255), 'text'=>true, 'font'=>'helvetica', 'fontsize'=>8, 'stretchtext'=>4), 'N'));


$html .= '<table width="100%">

<tr><td colspan="2" width="63%"><div><img src="https://www.stopoint.com/images/logo.png" width="120" hieght="80"/></div></td><td colspan="2"><div style="float:right"><tcpdf method="write1DBarcode" params="'.$params.'" /></div></td></tr></table><br>';
...
<li>Please include the charger.</li></ul></p> 
...
<td ><div>
  ...
  <tr><td colspan="3">For questions about shipping, find answers at: www.stopoint.com/help</td>
     ...
     <tr>
<td colspan="6"><img src="shippinglabels/'.$row2['TrackingCode'].'.png" class="labelImage"/></td>
...
$pdf->setImageScale(1.53);
$pdf->Image($file, 5, 2, '', '', '', '', '', false, 72, '', false, false, 0);
//$pdf->Image($file, '', '', 0, 0, '', '', 'T', false, 300, '', false, false, 1, false, false, false);
