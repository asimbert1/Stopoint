                        ...
                        if ($_GET['tab'] == "tab_overview") {
                         ...
                         <li class="active"><a href="#tab_overview" data-toggle="tab"><i class="fa fa-dashboard"></i>Overview</a></li>
                            <li><a href="#tab3"  data-toggle="tab"><i class="fa fa-shopping-cart"></i>My Orders</a></li>
                             <li><a href="#tab3"  data-toggle="tab"><i class="fa fa-shopping-cart"></i>Reviews <?php if($countnum2>0){ ?> <span style="color: red;">(<?=$countnum2?>)</span> <?php }else{ ?> (<?=$countnum2?>) <?php } ?></a></li>
			...
			$newsletter;
                ...
                if ($_POST['changepassword']) {
                    ...
                    if (!Bcrypt::checkPassword($_POST['NewConfirmPassword'], $hashedNewPassword)) {
                        ...
                        <?php
                        header('Location: ' . $base_url . '/dashboard-test2?tab=tab2&status=error&type=password_mismatch');
                    //} else if (($_POST['NewPassword'] == $_POST['NewConfirmPassword']) && ($_POST['CurrentPassword'] == $weuser['Password'])) {
                        ...
                        <?php
                        header('Location: ' . $base_url . '/dashboard-test2.php?tab=tab2&status=success');
                    //} else if (($_POST['CurrentPassword'] != $weuser['Password'])) {
                        ...
                        <?php
                        header('Location: ' . $base_url . '/dashboard-test2.php?tab=tab2&status=error&type=current_password_wrong');
                    }
                }
                ?>
...
?>
                                        ...
                                        <ul id="tabList" role="tablist" class="nav nav-tabs">
                                            ...
                                            <li <?php if (isset($_GET['msg']) == 'testimonials') { ?> class="active" <?php } ?> role="presentation" class="">
                                                <a data-toggle="tab" role="tab" aria-controls="completed" href="#Testimonials">Review <?php if($countnum>0){ ?> <span style="color: red;">(<?=$countnum?>)</span> <?php }else{ ?> (<?=$countnum?>) <?php } ?></a>
                                            </li>
                                        </ul>
                                                            ...
                                                            while ($rowordertest = mysql_fetch_assoc($rowsordertest)) {
                                                                ...
                                                                if ($numrowstest == '0') {
                                                                    ...
                                                                    <form role="form" method="post" action="" class="validate-form" onsubmit="return validateRating(rating)">
                                                                        <h1 class="form-heading"><?php echo htmlspecialchars($rowordertest['Description']); ?></h1> <div class="form-group">

<!-- TrustBox widget -->
<div class="trustpilot-widget" data-locale="en-US" data-template-id="56278e9abfbbba0bdcd568bc" data-businessunit-id="566208860000ff0005865012" data-style-height="70px" data-style-width="150%">
...
<!-- End TrustBox widget -->
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="contents" id="contents" class="form-control" placeholder="Your feedback is very important as it helps us identify areas we need to improve. Please leave a review so we can continue to better serve you." required="required"></textarea>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="hidden" name="orderidhidden" value="<?= $rowordertest['OrderId'] ?>"/>
