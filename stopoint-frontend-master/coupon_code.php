...
$_GET['sort'] = 'id';
$_GET['sort'] = 'copon_code';
$table_name = 'coupon_code';
$table = new table($table_name);
$table->addJoined('Coupon-Code', 'Coupon-Code', false, '', '');
$table->addField('Description', 'Description', false, '', '');
$table->addField('Expiration_date', 'Expiration_date', false, '', '');
$table->searchable = array('id','copon_code','Description'); 
...
$(document).ready(function(){ 
	...
	$(function() {
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<a href="<?=$_SERVER['PHP_SELF']?>?sort=Date&desc"><h2>Coupon Code</h2></a>
