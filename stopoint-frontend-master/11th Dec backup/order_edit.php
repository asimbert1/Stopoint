				...
				<div class="content-box-content">
							...
							<form action="" method="post" >
								...
								<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
									...
									<input class="text-input small-input" type="text" name="checknumber" id="checknumber" size="20" readonly="readonly"/>
					<br/>
...
?>
									...
									<input class="text-input small-input" type="text" name="paypaltransactionnumber" size="20" value="" readonly="readonly"/>
					<br/>
...
<body>
	<table style="margin-left:-16;margin-top:-10">
		<tr>
			<td width="70">
				<img src="images/logo.png" width="90%" style="margin-top:-27">
			</td>
			<td width="130" style="font-size:14px; line-height:0.8;">
				<span style="font-size:16px;">STOPOINT INC</span><br/>
				<span style="font-size:15px;">12795 NE 10th Avenue</span><br/>
				<span style="font-size:15px;">#14</span><br/>
			...
			<p style="text-align: right; margin-top:-15; margin-bottom:23;  font-size:19px;">'.$checknumber.'</p>
		...
		<tr>
			...
			<td width="405">
				<p style="padding:0 20; border-bottom:2px solid grey; font-size:16px;">Ally Simbert</p>
			</td>
			<td>
				$
			</td>
	...
	<table style="margin-top:13;">
		<tr>
			<td style="font-size:20px; font-family:'."'OCR A Extended;'".'" align="center" width="570">
				"'.$checknumber.'" |:063107513|: 37428168096"
			</td>
