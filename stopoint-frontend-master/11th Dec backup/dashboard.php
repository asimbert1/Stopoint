                                                            ...
                                                            while ($rowordertest = mysql_fetch_assoc($rowsordertest)) {
                                                                ...
                                                                if ($numrowstest == '0') {
                                                                    ...
                                                                    <form role="form" method="post" action="" class="validate-form" onsubmit="return validateRating(rating)">
                                                                        <h1 class="form-heading"><?php echo htmlspecialchars($rowordertest['Description']); ?></h1>
																		
                                                                        <div class="form-group">
<!-- TrustBox widget - Review Collector -->
<div class="trustpilot-widget" data-locale="en-US" data-template-id="56278e9abfbbba0bdcd568bc" data-businessunit-id="566208860000ff0005865012" data-style-height="52px" data-style-width="100%" data-group="a" data-stars="1,2,3,4,5">
  <a href="https://www.trustpilot.com/review/stopoint.com" target="_blank">Trustpilot</a>
</div>
<!-- End TrustBox widget -->																			
																		</div>
                                                                        <div class="form-group">
																		Or Leave a review on our website in the box below
																		</div>
                                                                        <div class="form-group">
